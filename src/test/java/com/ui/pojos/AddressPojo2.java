...
public class AddressPojo2 {
	...
	public AddressPojo2(String company, String address1, String address2, String city, String state, String postcode,
	...
	public String toString() {
		return "AddressPojo2 [company=" + company + ", address1=" + address1 + ", address2=" + address2 + ", city="
				+ city + ", state=" + state + ", postcode=" + postcode + ", homePhone=" + homePhone + ", mobilePhone="
